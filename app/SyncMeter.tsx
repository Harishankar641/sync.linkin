      ...
      >
        ...
        {nextStep && (
          ...
          >
            ...
            {nextStep?.startsWith("Connect another source") ? (
              <a href="/twin#context-sources" style={{ color: "var(--amber-bright)", textDecoration: "underline" }}>
                {nextStep}
              </a>
            ) : nextStep?.startsWith("Have another conversation") ? (
              <a href="/twin-lab" style={{ color: "var(--amber-bright)", textDecoration: "underline" }}>
                {nextStep}
              </a>
            ) : (
              nextStep
