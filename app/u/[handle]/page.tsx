...
export default async function PortfolioPage({
  ...
  // Generated by /api/portfolio-generate via the AI model over the full
  ...
  // used to BUILD portfolio_page via the AI model — we just don't dump
  ...
  return (
    ...
    >
      ...
      {/* On the legacy template, give the owner a Generate button so
          they can flip to the custom AI-designed site. Hidden for
          non-owners (they shouldn't trigger AI-generation spend). */}
