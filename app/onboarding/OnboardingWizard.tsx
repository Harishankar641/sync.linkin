...
export function OnboardingWizard({
  ...
  // Goal-aware follow-up answers — generated by the AI in
  ...
  // Composed goals string — user's typed goals + AI-generated
  ...
  // /api/suggest-refine which uses the AI to draft answers from the
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
              ...
              {/* Goal-aware follow-ups. When the user types a real goal,
                  The AI generates 3-5 tailored questions to sharpen the
