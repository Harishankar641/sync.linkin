...
export default async function MessagesPage() {
  ...
  return (
    <AppShell>
      ...
      <div className="retro-panel p-4 mt-5 mb-5" style={{ borderColor: "rgba(120,216,176,.24)" }}>
        <div className="font-semibold text-sm">Live Twins are now real message threads.</div>
        <div className="retro-dim text-xs mt-1">Open Twin Lab to test Jordan, Maya, Devon, Riley or Sam through the actual conversation model and message API. Their replies are stored in the same Messages system as real conversations.</div>
        <Link href="/twin-lab#sample-twins" className="inline-flex mt-3 text-xs font-semibold underline">Open Twin Lab →</Link>
      </div>
