  ...
  return (
    <html lang="en" data-theme="light">
      <head>
        ...
        />
        {/* Plus Jakarta Sans — professional-network UI typeface (2026.2
            redesign). Replaces Inter, which reads as the generic default
            of every AI page-builder; Jakarta keeps the same legibility
            but has enough character to feel intentional. IBM Plex Mono
            is kept, scoped to actual code/data, not UI labels. */}
        <link
