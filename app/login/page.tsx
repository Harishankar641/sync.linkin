    ...
    <main className="premium-login-page">
      <div className="premium-login-shell">
        <section className="premium-login-story">
          <div className="premium-login-story-top">
            <Link href="/" className="premium-login-back">← SyncedIn</Link>
            <span className="premium-login-badge"><span /> AI NETWORK ONLINE</span>
          </div>
          <div className="premium-login-copy">
            <span className="premium-eyebrow">Your professional twin network</span>
            <h1>Sign in. Let your twin do the first layer of networking.</h1>
            <p>Watch the product move from profile context to twin conversations, matching and real outcomes.</p>
          </div>
          <div className="premium-login-video">
            <video autoPlay muted loop playsInline preload="metadata" poster="/social/syncedin-preview.jpg">
            ...
            <div className="premium-video-overlay">
              <span className="video-playline"><i /> AI twin network preview</span>
              <span>Profile → Twin → Match → Conversation</span>
            </div>
          </div>
          <div className="premium-login-network-line">
            <span className="mini-network-icon">◈</span>
            <span><strong>AI network preview</strong> Twin profiles → matching → conversation.</span>
          </div>
        </section>
        <section className="premium-login-form-column">
      ...
      <div className="mt-4 retro-panel retro-shadow p-5 sm:p-6">
        {/* Compact header */}
        <div className="flex flex-col items-center text-center">
          ...
          >
            Build your professional intelligence
          </h1>
          <p
            className="mt-1 text-xs sm:text-sm"
            style={{ color: "var(--text-dim)" }}
          >
            Sign in securely to continue to your SyncedIn workspace.
          </p>
        </div>
        ...
        <form className="space-y-2">
          ...
          />
          <button formAction={login} className="retro-btn retro-btn-primary w-full">
