      ...
      <section className="mt-10">
        ...
        <div className="mt-3 space-y-5">
          ...
          <Q
            ...
            a={
              <>
                ...
                . Short version: Supabase (database), one of Google
                Gemini / Groq / OpenRouter / Mistral / Cohere (message
                generation — whichever is available), Apify / ScrapingDog
                / Exa (public profile scraping when you invite someone),
                Resend (email), Microsoft Clarity (anonymized analytics).
              </>
            }
          />
          <Q
          ...
          <Q
            ...
            a="Currently, potentially yes: this project runs on free API tiers across several providers (Gemini, Groq, OpenRouter, Mistral, Cohere), and free-tier terms vary — several of them, including Google's free Gemini tier, allow using submitted data to improve their products, including training. Paid tiers on these same providers typically carry a no-training commitment; we're on free tiers during development. We don't provide your data to any model trainer beyond whichever of these providers actually handled a given request."
          />
        </div>
      </section>
