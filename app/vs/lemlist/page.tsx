    ...
    <VsPageShell
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Lemlist personalizes via custom variables you define ({{firstName}}, {{company}}, etc.). SyncedIn scrapes the recipient's public footprint (LinkedIn, X, web) and AI composes the entire opening message from scratch — different angle for every recipient, never a templated mail-merge."
        },
        {
